...
const Services = () => {
  return (
    <div className="flex flex-col my-6 md:my-10 mx-2 md:mx-auto">
      ...
      <div className="flex flex-col md:mx-auto sm:grid sm:grid-cols-2 gap-4 mx-2 lg:grid-cols-3 justify-between">
        <div className="flex flex-col mx-auto p-4 rounded-xl shadow-lg hover:shadow-xl shadow-gray-200/75">
          <TbListDetails className="p-2 text-6xl bg-turbo-pink-500 text-white rounded-full mx-auto" />
        ...
        <div className="flex flex-col mx-auto p-4 rounded-xl shadow-lg hover:shadow-xl shadow-gray-200/75">
          <HiRefresh className="p-2 text-6xl bg-turbo-pink-500 text-white rounded-full mx-auto" />
          <h1 className="font-bold text-xl md:text-3xl">
        ...
        <div className="flex flex-col mx-auto p-4 rounded-xl shadow-lg hover:shadow-xl shadow-gray-200/75">
          <MdWork className="p-2 text-6xl bg-turbo-pink-500 text-white rounded-full mx-auto" />
          <h1 className="font-bold text-xl md:text-3xl">
